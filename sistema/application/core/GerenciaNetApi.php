...
class GerenciaNetApi {
    ...
    public function updateSubscriptionMetadata($subs, $matriculaId) {
        ...
        $params = [
            'id' => $subs['data']['subscription_id']
        ];


        return $this->api->updateSubscriptionMetadata($params, $body);
     ...
     * @return mixed
     */
    public function  getSubscription ($subsId){
        ...
        try {
            $subscription = $this->api->detailSubscription($params, []);
        }
