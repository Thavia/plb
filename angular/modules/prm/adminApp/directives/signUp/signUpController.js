...
app.directive('adminAppSignUp', ['$rootScope', 'signUpService', 'EVENTOS', '$locale', function ($rootScope, signUpService, $locale) {
    return {
        restrict: 'E',
        templateUrl: 'modules/prm/adminApp/directives/signUp/views/index.html',
        ...
        controller: ['$scope', '$locale', '$window','$location',function ($scope, $locale,$window,$location) {
            ...
            var crudConfig = {
                viewBaseUrl: 'modules/prm/adminApp/directives/signUp/views',
                modos: {
                    usuario: {
                        titulo: "Nova Conta de Usuario"
                    },
                    curso: {
            ...
            angular.extend(this, new CrudBaseController($scope, crudConfig, 'usuario'));
            /**
             * Modelo para edição
             */
            var self = this;
